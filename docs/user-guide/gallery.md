...
The `examples/example-gallery.tex` file contains a comprehensive showcase of lpmresonance features. This page highlights key examples with minimal code snippets.
