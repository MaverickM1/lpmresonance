...
\tikzset{
  ...
  lp/inside corner label/.style={anchor=south east, scale=0.85, font=\scriptsize},
}
...
\tikzset{
  ...
  lplpath/inside corner label style/.style={lp/inside corner label/.style={#1}},
}
...
\newcommand\highlightInsideCorner[3][red]{%
  \ifcsname lp@path@insidecornercoord@#2@#3\endcsname
    ...
    \node[lp/inside corner label] at \lp@cornercoord {\lp@cornercoord};%
  \else
