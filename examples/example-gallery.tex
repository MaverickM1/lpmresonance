...
\drawLatticePath[lplpath/show endpoints]{S1}
\end{minted}
...
\begin{minted}[fontsize=\small]{latex}
\lpDeclarePath{Lower}{000011111}
\lpDeclarePath{Upper}{10110100}
...
\drawLatticePath[violet, thick]{Big}
\end{minted}
...
\begin{tikzpicture}[scale=0.5]
  \lpDeclarePath{Big}{000011110000111100001111}
  \drawLatticePath[violet, thick, lplpath/label upmarks]{Big}
  \drawGrid{Big}
\end{tikzpicture}
\end{center}
